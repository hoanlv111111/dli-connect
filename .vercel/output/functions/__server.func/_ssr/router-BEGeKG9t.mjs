...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BEGeKG9t.js
...
var styles_default = "/assets/styles-C5ruI3e0.css";
var APP_NAME = "SIGNAL";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Connect people. Read the score. Decode the network."
			},
			{
				name: "theme-color",
				content: "#0a0a0b"
...
var $$splitComponentImporter = () => import("./routes-lDDcA9o_.mjs");
